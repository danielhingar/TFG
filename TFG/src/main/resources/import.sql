...
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (1,991,'ZAPATILLA NIKE AIR-MAX','Zapatillas Nike Air-Max último modelo con las nuevas plantillas adaptativas a tu pie','a5c29446-6b41-45ff-805d-5d9f2dc9b896_air-max-200-zapatillas-M5t3W6.jpg',100.70,'2019-11-23','MODA','37,38,39,40,41',null,null,'550 gramos',null,null,null,'NIKE',null,'DISPONIBLE',10);
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (2,992,'ZAPATILLA ULTRABOOST','Zapatillas para correr con suela Ultraboost para adaptarse mejor a las imperfecciones del suelo','66f68295-6cf5-4081-abdb-7357e10f48c7_descarga(3).jpg',120.70,'2019-11-23','MODA','37,38,39,40,41',null,null,'550 gramos',null,null,null,'ADIDAS',null,'DISPONIBLE',10);
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (3,991,'LÁMPARA DE TECHO METAL','Lámpara de aluminio perfecta para el salón, no incluye bombilla.','e371aff3-baea-454d-a85e-db1fad1a9aaa_descarga.jpg',50.50,'2019-11-23','HOGAR Y DECORACIÓN',null,null,null,'300 gramos','20 pulgadas',null,null,'NIKE',null,'DISPONIBLE',10);
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (4,992,'CHAQUETA ACOLCHADA','Chaqueta de lana nueva temporada invierno',null,69.7,'2019-11-23','MODA','S,M,L,XL',null,null,'550 gramos',null,null,null,'SPRINGFIELD',20,'DISPONIBLE',10);
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (5,991,'CAMISETA MANGA CORTA','Camiseta de algodón de manga corta con logo de mickey mouse, cuello redondo.','59ee03f8-dd06-4dd0-ab83-d807bd4a3747_descarga(1).jpg',30.25,'2019-11-23','MODA','S,M',null,null,null,null,null,null,'PULL&BEARD',null,'DISPONIBLE',1);
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (6,992,'IPHONE 11','IPHONE 11 móvil de última genereción, 6.1" Liquid Retina HD, Chip A13 Bionic, iOS',null,1000.50,'2019-11-23','INFORMÁTICA Y ELECTRÓNICA',null,'18 cm','7 cm','750 gramos','6.1',null,'32GB,64GB,128GB','IPHONE',null,'DISPONIBLE',1);
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (7,991,'PORTATIL HP','Portatil HP con procesador de última generación i9, 16GB de RAM, 15.6" Full HD.',null,601.70,'2019-11-23','INFORMÁTICA Y ELECTRÓNICA',null,'20 cm','40 cm','550 gramos','15.6',null,'250GB,500GB,1TB','HP',null,'SINSTOCK',0);
...
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (10,991,'ZAPATILLAS DE DEPORTE','Zapatillas de deporte para corren con almohadillas',null,100.70,'2019-11-23','MODA','37,38,39,40,41',null,null,'550 gramos',null,null,null,'ADIDAS',null,'DISPONIBLE',2);
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (11,991,'CAMISETA NIKE','Camiseta nike de manga corta ultima temporada',null,100.70,'2019-11-23','MODA','37,38,39,40,41',null,null,'550 gramos',null,null,null,'ADIDAS',null,'DISPONIBLE',2);
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert,status,stock) VALUES (12,992,'CHAQUETA DE CUERO','Chaqueta de lana nueva temporada invierno',null,69.7,'2019-11-23','MODA','S,M,L,XL',null,null,'550 gramos',null,null,null,'SPRINGFIELD',20,'DISPONIBLE',2);
