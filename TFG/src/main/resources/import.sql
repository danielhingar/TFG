...
INSERT INTO `product` (id,company_id,name,description,photo,price,create_date,category,size,height,width,weight,inch,capacity,memory,brand,offert) VALUES (5,991,'CAMISETA MANGA CORTA','Camiseta de algodón de manga corta con logo de mickey mouse, cuello redondo.',null,30.25,'2019-11-23','CLOTHES','S,M',null,null,null,null,null,null,'PULL&BEARD',null);
